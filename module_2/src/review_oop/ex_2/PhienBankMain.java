...
public class PhienBankMain {
    Scanner scanner = new Scanner(System.in);
    List<PhienBank> bankAccountList = new ArrayList<>();
    PhienBank bankAccount1 = new PhienBank(1234568, "Account1", 10000000);
    PhienBank bankAccount2 = new PhienBank(1234567, "Account2");
    PhienBank bankAccount3 = new PhienBank(1234569, "Account3");

    public static void main(String[] args) {
        PhienBankMain bankAccountMain = new PhienBankMain();
    ...
    private void transferToOtherAcc(List<PhienBank> bankAccountList) {
    ...
    private void expiredFromAccount(List<PhienBank> bankAccountList) {
    ...
    private void withdrawalFromAccount(List<PhienBank> bankAccountList) {
    ...
    private void checkBalance(List<PhienBank> bankAccountList) {
    ...
    public void paymentToAccount(List<PhienBank> bankAccountList) {
        System.out.println("Enter the account you want to payment");
        long accountNumber = Long.parseLong(scanner.nextLine());
        int indexAccount = checkAccountAvailable(bankAccountList, accountNumber);
        if (indexAccount != -1) {
            ...
            bankAccountList.get(indexAccount).payAccount(moneyPayment);
            System.out.println("Your selection already done\n" +
                    "The account after payment\n" + bankAccountList.get(indexAccount));
        } else {
            System.out.println("The " + accountNumber + " not available");
    ...
    public int checkAccountAvailable(List<PhienBank> bankAccountList, long accountNumber) {
